...
#NOTAS : es aconsejable a la hora de pedir variables por consola usar el caracter reservado f y poner el tipo de dato entre corchetes.
numeroVeces = int(input("Cuantos numeros vas a introducir : "))
sumaTotal = float(0)
for x in range (0,numeroVeces) :
    num = float(input(f"NUMERO {x+1} : "))
    sumaTotal+=num

print("La suma de los numeros introducidos es :",sumaTotal)
...
print("La cantidad de los numeros negativos introducidos es :",numN)    
...
#mostrando el resultado con el formato indicado en el siguiente ejemplo (necesitarás utilizar una variable tipo lista) .
num = 0
while num <= 0 :
    num = int(input("Introduzca un valor entero mayor que cero : "))
...
#que el programa determine si el número es primo o no, el resultado podría2) 
